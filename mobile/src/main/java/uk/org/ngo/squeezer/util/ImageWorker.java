...
public abstract class ImageWorker {
     ...
     * uk.org.ngo.squeezer.util.ImageWorker#processBitmap(Object)} to define the processing logic). A memory and disk cache
     * will be used if an {@link uk.org.ngo.squeezer.util.ImageCache} has been set using {@link
     * uk.org.ngo.squeezer.util.ImageWorker#setImageCache(uk.org.ngo.squeezer.util.ImageCache)}. If the image is found in the memory cache, it is set
     * immediately, otherwise an {@link uk.org.ngo.squeezer.util.AsyncTask} will be created to asynchronously load the
     * bitmap.
     *
    ...
    /**
     * Adds an {@link uk.org.ngo.squeezer.util.ImageCache} to this worker in the background (to prevent disk access on UI
     * thread).
     *
    ...
    /**
     * Sets the {@link uk.org.ngo.squeezer.util.ImageCache} object to use with this ImageWorker. Usually you will not need to
     * call this directly, instead use {@link uk.org.ngo.squeezer.util.ImageWorker#addImageCache} which will create and add
     * the {@link uk.org.ngo.squeezer.util.ImageCache} object in a background thread (to ensure no disk access on the main/UI
     * thread).
     *
     * @param imageCache
     */
