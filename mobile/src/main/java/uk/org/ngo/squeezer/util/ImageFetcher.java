...
/**
 * A subclass of {@link uk.org.ngo.squeezer.util.ImageWorker} that fetches images from a URL.
 */
public class ImageFetcher extends ImageResizer {
     ...
     * thread.
     *
     * @param data The key to load the bitmap, in this case, a regular http URL
     *
     ...
     *
     * @param outputStream The context to use
