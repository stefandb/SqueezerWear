 ...
 * data type is defined by the generic type argument, and must be an extension of {@link uk.org.ngo.squeezer.framework.Item}. You
 * must provide an {@link uk.org.ngo.squeezer.framework.ItemView} to provide the view logic used by this activity. This is done by
 * implementing {@link #createItemView()}.
 * <p/>
 * When the activity is first created ({@link #onCreate(android.os.Bundle)}), an empty {@link uk.org.ngo.squeezer.framework.ItemAdapter}
 * is created using the provided {@link uk.org.ngo.squeezer.framework.ItemView}. See {@link ItemListActivity} for see details of
...
public abstract class BaseListActivity<T extends Item> extends ItemListActivity implements IServiceItemListCallback<T> {
     ...
     * <p/>
     * The content view must contain a {@link android.widget.AbsListView} with the id {@literal item_list} and a
     * {@link android.widget.ProgressBar} with the id {@literal loading_progress} in order to be valid.
     *
     * @return The ID
     */
    ...
    /**
     * @return The current {@link uk.org.ngo.squeezer.framework.ItemAdapter}'s {@link uk.org.ngo.squeezer.framework.ItemView}
     */
    ...
    /**
     * @return The current {@link uk.org.ngo.squeezer.framework.ItemAdapter}, creating it if necessary.
     */
    ...
    /**
     * @return The {@link android.widget.AbsListView} used by this activity
     */
