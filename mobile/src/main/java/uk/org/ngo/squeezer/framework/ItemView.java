...
/**
 * Defines view logic for a {@link uk.org.ngo.squeezer.framework.Item}
 * <p/>
...
public interface ItemView<T extends Item> {
     ...
     * set. See {@link ItemAdapter#getView(int, android.view.View, android.view.ViewGroup)}
     *
     * @param convertView the old view to reuse, per {@link android.widget.Adapter#getView(int, android.view.View,
     ...
     * {@link ItemAdapter#getView(int, android.view.View, android.view.ViewGroup)}
     *
    ...
    /**
     * @return the creator for the current {@link uk.org.ngo.squeezer.framework.Item} implementation
     */
     ...
     *
     * @see android.view.View.OnCreateContextMenuListener#onCreateContextMenu(android.view.ContextMenu, android.view.View,
    ...
    /**
     * Extra menu information provided to the {@link android.view.View.OnCreateContextMenuListener#onCreateContextMenu(android.view.ContextMenu,
     * android.view.View, android.view.ContextMenu.ContextMenuInfo) } callback when a context menu is brought up for this ItemView.
     */
    public static class ContextMenuInfo implements ContextMenu.ContextMenuInfo {
        ...
        /**
         * The {@link uk.org.ngo.squeezer.framework.Item} for which the context menu is being displayed.
         */
