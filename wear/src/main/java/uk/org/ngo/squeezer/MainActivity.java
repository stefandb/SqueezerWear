...
//                        mArtist.setText("Andrew rayel");
                        ...
                        try {
                            ...
                            new SendToDataLayerThread(BluetoothService.DATA_ACTION+ "/previous", action.toString()).start();
                ...
                mbtnplay.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            ...
                            Log.d("wear:squeezer-plat-action", action.toString());
                            new SendToDataLayerThread(BluetoothService.DATA_ACTION + "/play", action.toString()).start();
                ...
                mbtnnext.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            ...
                            Log.d("wear:squeezer-plat-action", action.toString());
                            new SendToDataLayerThread(BluetoothService.DATA_ACTION+ "/next", action.toString()).start();
    ...
    public void onDataChanged(DataEventBuffer dataEvents) {
        ...
        for (DataEvent event : events) {
            ...
            if (BluetoothService.DATA_CURRENT_SONG.equals(path)) {
...
//                generateEvent("Unknown data event type", "Type = " + event.getType());
    ...
    public void onMessageReceived(MessageEvent messageEvent) {
        ...
        if (messageEvent.getPath().equals(BluetoothService.DATA_CURRENT_SONG)) {
...
//                mTitle.setText(numberinfo.getString("title"));
    ...
    protected void onStart() {
        ...
        new SendToDataLayerThread(BluetoothService.DATA_ACTION+ "/current", action.toString()).start();
